...
import shelve  # Updated: Replaced pickledb with shelve
...
# possible area of further development
# Real-time events - setup getting events pushed from the machine rather than polling.
